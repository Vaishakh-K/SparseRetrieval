...
class ModelArguments:
    ...
    do_expansion: bool = field(default=False, )
    splade_separate_loss: bool = field(default=False, )
    expansion_weight: float = field(default=1.0, )
    tokens_weight: float = field(default=1.0, )
    expansion_weight_learned: bool = field(default=False, metadata={"help": "whether to learn the expansion weight parameter"})
    lambda_q: float = field(default=1.0, )
    lambda_d: float = field(default=1.0, )
    expansion_normalization: str = field(default="max", metadata={"help": "choices = max, sum"})
...
class COILTrainingArguments(TrainingArguments):
    ...
    predict_expanison_terms: bool = field(default=False, metadata={"help": "Whether to run inference using splade"})